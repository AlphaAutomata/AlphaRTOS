...
typedef enum ARTOS_eI2CEvent_ {
    ...
    ARTOS_eI2CEvent_REQ_RD   = 4, //!< Received read request from remote master.
    ARTOS_eI2CEvent_REQ_WR   = 5  //!< Received write request from remote master.
} ARTOS_eI2CEvent;
...
typedef struct ARTOS_Event_I2C_ {
    ...
    uint_fast16_t   addr;     //!< The address of the remote I2C device.
